    ...
    public class GestionGolfs
    {
        ...
        public static List<GolfCourse> getListGolfs(Filter<GolfCourse>.Filtre filtre)
        {
            ...
            if (true/*!existe*/)
            {
                ...
                XDocument xDocumentForListOfGolfCoursesFiles = XDocument.Load(GenerateStreamFromString(text));


                foreach ( var node in xDocumentForListOfGolfCoursesFiles.Element("GolfCourses").Elements("GolfCourse"))//get the list of all golfCourses
                {
